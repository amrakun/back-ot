...
export const companyFactory = (params = {}) => {
  const company = new Companies({
    basicInfo: {
      ...
      website: params.website || faker.internet.url(),
      email: params.email || faker.internet.email(),
      address: params.address || faker.random.word(),
      address2: params.address2 || faker.lorem.sentence(),
      address3: params.address3 || faker.lorem.sentence(),
      ...
      registeredInAimag: params.registeredInAimag || 'Aimag',
      registeredInSum: params.registeredInSum || 'Sum',
