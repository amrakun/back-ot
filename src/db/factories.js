...
export const supplierFactory = (params = {}) => {
  const company = new Companies({
    basicInfo: {
      ...
      sapNumber: params.sapNumber !== undefined ? params.sapNumber : faker.random.word(),
      email: params.email !== undefined ? params.email : faker.internet.email(),
      address: params.address !== undefined ? params.address : faker.random.word(),
      address2: params.address2 !== undefined ? params.address2 : faker.random.word(),
      address3: params.address3 !== undefined ? params.address3 : faker.random.word(),
      townOrCity: params.townOrCity !== undefined ? params.townOrCity : faker.random.word(),
      province: params.province !== undefined ? params.province : faker.random.word(),
      zipCode: params.zipCode || 976,
      country: params.country !== undefined ? params.country : 'Mongolia',
      registeredInCountry:
        params.registeredInCountry !== undefined ? params.registeredInCountry : 'Mongolia',
      registeredInAimag:
        params.registeredInAimag !== undefined ? params.registeredInAimag : faker.random.word(),
      registeredInSum:
        params.registeredInSum !== undefined ? params.registeredInCountry : faker.random.word(),
      corporateStructure: params.corporateStructure || faker.random.word(),
      registrationNumber:
        params.registrationNumber !== undefined ? params.registrationNumber : faker.random.number(),
      certificateOfRegistration:
        params.certificateOfRegistration !== undefined
          ? params.certificateOfRegistration
          : { name: faker.random.word(), url: faker.random.word() },
      website: params.website !== undefined ? params.website : faker.internet.url(),
      phone: params.phone !== undefined ? params.phone : faker.internet.url(),
      isChinese: params.isChinese !== undefined ? params.isChinese : true,
      foreignOwnershipPercentage:
        params.foreignOwnershipPercentage !== undefined
          ? params.foreignOwnershipPercentage
          : faker.random.number(),
      totalNumberOfEmployees:
        params.totalNumberOfEmployees !== undefined
          ? params.totalNumberOfEmployees
          : faker.random.number(),
      totalNumberOfMongolianEmployees:
        params.totalNumberOfMongolianEmployees !== undefined
          ? params.totalNumberOfMongolianEmployees
          : faker.random.number(),
      totalNumberOfUmnugoviEmployees:
        params.totalNumberOfUmnugoviEmployees !== undefined
          ? params.totalNumberOfUmnugoviEmployees
          : faker.random.number(),
    },
